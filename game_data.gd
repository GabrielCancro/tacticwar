...
var TROPS = {
	"cam":{"food":20, "wood":50, "desc":"Warrior trop! "},
	"gue":{"food":20, "wood":60, "pop":1, "desc":"Increment production of food"},
	"arq":{"food":30, "wood":30, "pop":1, "desc":"Increment production of wood"},
	"jin":{"wood":100, "stone":100, "pop":1, "desc":"Defensive to attack enemy trops"},
	"cat":{"wood":50, "stone":100, "desc":"Defensive to resistence enemies attacks"},
}
